...
class Editor:
    ...
    def __init__(self, root):
        ...
        self.close_btn_img = PhotoImage(file="cross.png")
    ...
    def main_function(self):
        ...
        Button(self.wiki_frame, text="<-open page on editor", cursor="hand2", bg=self.buttons_color, fg=self.font_color, command=self.open_page_on_editor).place(
            x=10, y=550)
        Button(self.wiki_frame, text="Traslator", cursor="hand2", width=10, bg=self.buttons_color, fg=self.font_color, command=self.Translator).place(
            x=175, y=550)
